 ...
 * @author Van Nam
 */
public class FormDiemThi extends javax.swing.JFrame {

    /**
     * Creates new form FormDiemThi
     */
    private ArrayList<Gmail> listgmail = new FileGmail().getGmail();
    ...
    private void initComponents() {
        ...
        jButtonDangNhap.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jButtonDangBack.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jButtonDangBack, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGap(195, 195, 195)
    ...
    private void jButtonDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDangNhapActionPerformed
        ...
        listgmail = new FileGmail().getGmail();
        boolean ktra = false;
        ...
        for (int i = 0; i < listgmail.size(); i++) {
            if (jTextFieldEmail.getText().equals(listgmail.get(i).getEmail())
                    && password.equals(listgmail.get(i).getPassword())) {
                this.setVisible(false);
                ScoreForm scoreForm = new ScoreForm();
                scoreForm.setVisible(true);
                scoreForm.setjLabelNameTeacher(listgmail.get(i).getName());
                ktra = true;                
                break;
            }
            if (jTextFieldEmail.getText().equals(listgmail.get(i).getEmail())) {
        ...
        if (ktra == false && checkEmail == false) {
            JOptionPane.showMessageDialog(rootPane, "Email hoặc số điện thoại không đúng");
        } else if (ktra == false && checkEmail == true) {
...
//            java.util.logging.Logger.getLogger(FormDiemThi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new FormDiemThi().setVisible(false);
//            }
//        });
//    }
